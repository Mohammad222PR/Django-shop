...
class PaymentZarin(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=0, default=0, verbose_name=_('amount'))
    ...
    status = models.IntegerField(choices=PaymentStatusType.choices, default=PaymentStatusType.pending.value, verbose_name=_('status'))
